...
html,body{ 
 ...
 body {
  ...
  background: url(https://i.imgur.com/2vOXiPV.jpg?1);
...
<body>
  ...
  <div id = "particles-js">
  <div class="container border mt-3 hello col-md-3">
      <div class="row">
        <div class="col-md-12 border-left py-3">
          <center><h1 class="heading">Contact Us</h1></center>
          <div class="form-group">
            <h5 for="name" class="pb-2">Name</h5>
            <input
              type="text"
              class="form-control"
              id="name"
          ...
          <div class="form-group">
            <h5 for="email" class="pb-2">Email</h5>
            <input
              type="email"
              class="form-control"
              id="email"
          ...
          <div class="form-group">
            <h5 for="message" class="pb-2">Message</h5>
...
particlesJS('particles-js', {
  ...
  <script
    ...
    <script type="text/javascript">
      (function () {
        emailjs.init("fDvDScvRrXDjL09Wp");
      })();
    </script>
    <script>
        function sendMail() {
  ...
  const serviceID = "service_7tkjvqe";
  const templateID = "template_l1aa8mv";
